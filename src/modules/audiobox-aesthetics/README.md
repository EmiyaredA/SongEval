...
2. Install directly from source
 ...
 推荐安装命令
 ```shell
 # 创建环境（Python 3.9-3.12 都可以）
 conda create -n audiobox python=3.10 -y
 conda activate audiobox

 # 安装 PyTorch（CUDA 12.4 版本兼容你的 CUDA 12.8）
 pip install torch torchaudio --index-url https://download.pytorch.org/whl/cu124

 # 从源码安装 audiobox-aesthetics
 cd /mnt/cache/huangzhiyuan/SongEval/src/modules/audiobox-aesthetics
 pip install -e .
 ```
